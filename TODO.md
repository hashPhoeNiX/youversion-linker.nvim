...
- [x] **Add a minimal, reproducible config in the README** for quick testing.
...
- [x] **Add a `setup()` function** that does not have side effects.
...
- [x] **Add support for user configuration overrides.**
- [ ] **Add support for disabling/enabling features via config.**
- [x] **Add support for custom keymaps.**
- [x] **Add support for custom filetypes.**
- [x] **Add support for custom popup appearance.**
...
- [ ] Allow bible passage text cache to persist until the buffer is closed
