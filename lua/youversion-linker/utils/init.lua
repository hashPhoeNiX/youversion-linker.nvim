return {
    book_lookup = require('youversion-linker.utils.book_lookup'),
    build_url = require('youversion-linker.utils.build_url'),
    extract_verse = require('youversion-linker.utils.extract_verse'),
